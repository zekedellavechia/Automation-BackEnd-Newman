...
newman run %collection% -e %environment% -n %iterations% -r htmlextra --reporter-htmlextra-browserTitle "PostManReport BE" --reporter-htmlextra-title "BE Testing Report" --reporter-htmlextra-logs --insecure
pause